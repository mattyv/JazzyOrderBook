...
#define GENERATE(...)                                                                                  \
    Catch::Generators::generate(                                                                       \
        INTERNAL_CATCH_STRINGIZE(INTERNAL_CATCH_UNIQUE_NAME(generator)), CATCH_INTERNAL_LINEINFO, [] { \
...
inline auto convertInto(std::string const& source, bool& target) -> ParserResult
{
    ...
    std::transform(
        srcLC.begin(), srcLC.end(), srcLC.begin(), [](unsigned char c) { return static_cast<char>(std::tolower(c)); });
